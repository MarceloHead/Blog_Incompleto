...
<body class="text-center">
    <main class="form-login">
        <form method="post" action="logar.php">
            <img class="mb-4" src="../images/administrador.png" alt="" width="70" height="70">
            ...
            <div><input type="submit" class="form-control" id="formGroupExampleInput" name="entrar" value="Entrar"></div>
        </form>
    </main>
</body>
</html>